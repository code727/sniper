...
/**
 * @description Storage组外网上传返回策略接口
 * @author  <a href="mailto:code727@gmail.com">杜斌</a>
 * @version 1.0
 */
public class StorageGroupInternetUploadReturnStrategy extends AbstractUploadReturnStrategy {
	...
	public String returnResult(Cluster cluster, String path) {
		...
		while (iterator.hasNext()) {
			...
			if (StringUtils.startsWith(path, groupEntry.getKey()))
				return returnResult(cluster.getStorageGroupInternetAccessURL(groupEntry.getKey()), path);
		}
		return null;
	}
