...
import org.workin.payment.service.online.AbstractOnlinePaymentService;
 ...
 * @version 1.0
 */
public class AlipayService extends AbstractOnlinePaymentService {
	...
	protected CodeMessageModel updatePayment(Map<String, String> payResponse) throws Exception {
		...
		payment.setStatus(ThirdPaymentStatus.getPayStatusCode(thirdCode));
		payment.setMessage(ThirdPaymentStatus.getPayMessage(thirdCode));
		// 只有等交易完成后才记录支付时间
