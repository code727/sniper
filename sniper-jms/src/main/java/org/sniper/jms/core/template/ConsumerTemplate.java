...
import org.sniper.jms.core.ConsumerService;
import org.sniper.jms.core.listener.ConsumeMessageListener;
import org.sniper.jms.core.strategy.ConsumeStrategy;
import org.sniper.jms.support.ConsumerServiceSupport;
	...
	protected <T> T doReceive(String strategyName, String destinationName, Destination destination, String messageSelector) {
		...
		try {
			...
			if (listener != null) {
				...
				if (org.sniper.jms.util.JmsUtils.isClientAcknowledge(session))
					message.acknowledge();
			}
