...
import org.workin.persistence.util.Operator;
...
import org.workin.persistence.util.Predicate;
import org.workin.persistence.util.PropertyFilter;
import org.workin.persistence.util.PropertyFilterChain;
...
public class PersistencePropertyFilterTest extends BaseTestCase {
	...
	public void testFilterChain() {
		...
		chain.add("g1", new PropertyFilter("name", "daniele", Operator.EQ));
