...
import org.workin.persistence.hibernate.HibernateCriteriaQueryCallback;
import org.workin.persistence.hibernate.HibernateCriteriaQueryCallbackDao;
import org.workin.persistence.hibernate.HibernatePersistenceDao;
 ...
 */
@Repository
public class Hibernate3PersistenceImpl<T, PK extends Serializable> extends
	...
	public void remove(PK primaryKey) {
		T entity = getHibernateTemplate().get(this.getEntityClass(), primaryKey);
		if (entity != null)
			remove(entity);
	}
