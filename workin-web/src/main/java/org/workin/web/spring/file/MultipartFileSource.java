...
import org.workin.support.file.source.AbstaractFileSource;
 ...
 * @version 1.0
 */
public class MultipartFileSource extends AbstaractFileSource<MultipartFile> {

	public MultipartFileSource(MultipartFile source) throws IOException {
		super(source);
	}
