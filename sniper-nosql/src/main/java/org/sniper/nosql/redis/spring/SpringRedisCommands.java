 ...
 */
@Repository
public class SpringRedisCommands extends SpringRedisSupport implements RedisCommands {
	...
	@Override
	public <K, V> List<V> sortByOptional(final String dbName, final K key, final SortOptional optional, final Class<V> valueType) {
