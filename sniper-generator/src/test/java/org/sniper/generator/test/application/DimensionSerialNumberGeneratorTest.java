 ...
 * @version 1.0
 */
public class DimensionSerialNumberGeneratorTest extends AbstractSpringGeneratorTest<String> {
	
	@Autowired
	private DimensionSerialNumberGenerator dimensionSerialNumberGenerator;
	
	public DimensionSerialNumberGeneratorTest() {
		this(false, true);
	}
	
	protected DimensionSerialNumberGeneratorTest(boolean uniquenessTest, boolean performanceTest) {
