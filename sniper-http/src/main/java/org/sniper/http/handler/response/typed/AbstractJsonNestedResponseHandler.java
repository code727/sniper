 ...
 * @version 1.0
 */
public abstract class AbstractJsonNestedResponseHandler extends AbstractTypedNestedResponseHandler {
	
	protected AbstractJsonNestedResponseHandler() {
		super();
	}
	
	protected AbstractJsonNestedResponseHandler(JsonSerializer jsonSerializer) {
