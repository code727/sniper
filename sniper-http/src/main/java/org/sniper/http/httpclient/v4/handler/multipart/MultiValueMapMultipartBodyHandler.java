...
import org.sniper.commons.kv.MultiValueMap;
 ...
 * @version 1.0
 */
public class MultiValueMapMultipartBodyHandler extends AbstractCompositeMultipartBodyHandler<MultiValueMap<String, Object>> {
	
	public MultiValueMapMultipartBodyHandler() {
		this(null);
	}
	
	public MultiValueMapMultipartBodyHandler(List<MultipartBodyHandler> multipartBodyHandlers) {
