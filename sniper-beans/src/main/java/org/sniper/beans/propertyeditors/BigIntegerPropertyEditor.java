...
public class BigIntegerPropertyEditor extends AbstractNumberPropertyEditor {
	...
	public BigIntegerPropertyEditor(boolean allowEmpty) {
		super(allowEmpty);
	}
	
	public BigIntegerPropertyEditor(String defaultValue) {
		super(defaultValue);
	}
			
	public BigIntegerPropertyEditor(boolean allowEmpty, String defaultValue) {
