 ...
 * @version 1.0
 */
public class DoublePropertyEditor extends AbstractNumberPropertyEditor {
	
	public DoublePropertyEditor() {
		super();
	}
	
	public DoublePropertyEditor(boolean allowEmpty) {
		super(allowEmpty);
	}
	
	public DoublePropertyEditor(String defaultValue) {
		super(defaultValue);
	}
