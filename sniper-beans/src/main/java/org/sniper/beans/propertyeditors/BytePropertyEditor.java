...
public class BytePropertyEditor extends AbstractNumberPropertyEditor {
	...
	public BytePropertyEditor(boolean allowEmpty) {
		super(allowEmpty);
	}
	
	public BytePropertyEditor(String defaultValue) {
		super(defaultValue);
	}
			
	public BytePropertyEditor(boolean allowEmpty, String defaultValue) {
